    ...
    <div class="col-xl-6 col-lg-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-white">Hoş Geldiniz!</h6>
            </div>
            <div class="card-body">
                <h5 class="card-title">İş Yönetim Paneli</h5>
                <p class="card-text">
                    Bu panel üzerinden günlük işlerinizi takip edebilir ve yönetebilirsiniz. 
                    Sol menüden "İşlerim" bölümüne giderek işlerinizi görüntüleyebilirsiniz.
                </p>
                <a href="my-tasks.php" class="btn btn-primary">
                    <i class="fas fa-tasks me-2"></i>İşlerimi Görüntüle
                </a>
            </div>
        </div>
    </div>
